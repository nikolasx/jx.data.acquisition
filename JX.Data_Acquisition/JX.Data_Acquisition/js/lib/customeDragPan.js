...
var R2TeamSolveMulitTouch= {
    ...
    resetTouchNavigation:function(){
        R2TeamMetro.map.getControlsBy('id', 'myTouchNavigation')[0].destroy();   //将TouchNavigation 销毁 
        ...
        R2TeamMetro.map.addControl(nav);
        R2TeamMetro.map.events._msTouches.length = 0;
        nav.activate();
    }
